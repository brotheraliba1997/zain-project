                                ...
                                return(
                                    ...
                                    <div className="md:flex items-center">
                                            <div className="relative overflow-hidden md:shrink-0 shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                                <Image className="h-full w-full object-cover md:w-48 rounded-md group-hover:scale-110 duration-500" src={item.image} width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} alt=""/>
                                            ...
                                            <div className="md:ms-6 md:mt-0 mt-4">
                                                ...
                                                <ul className="list-none mt-2 space-x-1">
                                                    <li className="inline"><Link href="" className="size-6 rounded-full ring-2 ring-gray-200 dark:ring-slate-800 bg-red-600 inline-flex align-middle" title="Red"></Link></li>
                                                    <li className="inline"><Link href="" className="size-6 rounded-full ring-2 ring-gray-200 dark:ring-slate-800 bg-indigo-600 inline-flex align-middle" title="Blue"></Link></li>
                                                    <li className="inline"><Link href="" className="size-6 rounded-full ring-2 ring-gray-200 dark:ring-slate-800 bg-emerald-600 inline-flex align-middle" title="Green"></Link></li>
                                                </ul>

                                                <div className="mt-4">
                                                    <Link href="/shop-cart" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-slate-900 dark:bg-slate-800 text-white rounded-md shadow dark:shadow-gray-700">Add to Cart</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
